...
public class ModEnchantmentEffectComponentTypes {
    ...
    public static ComponentType<EnchantmentValueEffect> REGENERATION_BLESSING = register("regeneration_blessing", builder -> builder.codec(EnchantmentValueEffect.CODEC));
